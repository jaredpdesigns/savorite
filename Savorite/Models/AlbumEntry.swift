...
struct AlbumEntry: Codable, Identifiable {
    ...
    /* Apple Music artwork palette values stored as six-character RGB hex strings */
    let artworkBackgroundHex: String?
    let artworkPrimaryTextHex: String?
    ...
    init(
        ...
        artworkBackgroundHex: String? = nil,
        artworkPrimaryTextHex: String? = nil,
        libraryId: String = "",
        ...
        self.artworkBackgroundHex = artworkBackgroundHex
        self.artworkPrimaryTextHex = artworkPrimaryTextHex
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case artworkBackgroundHex
        case artworkPrimaryTextHex
        case libraryId
        case isFavorite
        case releaseDate
        case trackCount
    ...
    init(from decoder: Decoder) throws {
        ...
        artworkBackgroundHex = try container.decodeIfPresent(String.self, forKey: .artworkBackgroundHex)
        artworkPrimaryTextHex = try container.decodeIfPresent(String.self, forKey: .artworkPrimaryTextHex)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(artworkBackgroundHex, forKey: .artworkBackgroundHex)
        try container.encodeIfPresent(artworkPrimaryTextHex, forKey: .artworkPrimaryTextHex)
